    ...
    <div class="col-md-12 col-sm-12">
        ...
        <div class="page_header">
            <div class="page_header_menu">
                <a class="btn btn-sm btn-primary" href="{{ route('category.list') }}">Category List</a>
            </div>
        </div>

        <div class="x_panel">
            <div class="x_title">
                <h2>Cost Save for <small style="font-weight: bold; color:#000;">Branch : {{ session('branch_id') }}</small> </h2>
            ...
            <div class="x_content">
                ...
                <form class="" action="{{ route('cost.store') }}" method="post" novalidate>
                    ...
                    <div class="field item form-group">
                        <label class="col-form-label col-md-3 col-sm-3  label-align">খরচ<span class="required">*</span></label>
                    ...
                    <div class="field item form-group">
                        <label class="col-form-label col-md-3 col-sm-3  label-align">খরচের ধরণ<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6">
                    ...
                    <div class="field item form-group">
                        <label class="col-form-label col-md-3 col-sm-3  label-align">খরচের পরিমাণ<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" name="cost_amount" placeholder="in taka *" type="text" required="required" />
                        </div>
                        @error('cost_amount')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
