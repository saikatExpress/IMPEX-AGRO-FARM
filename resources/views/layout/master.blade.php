                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            {{-- Beef Menu List --}}
                            <li><a><i class="fa fa-desktop"></i> মাংস বিবরণী <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                            ...
                            {{-- Milk Menu List --}}
                            <li><a><i class="fa fa-table"></i> দুধ বিবরণী <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                            ...
                            <li><a href=""> <i style="font-size: 1.2rem;" class="fa-solid fa-bowl-food"></i> পশু খাদ্য</a></li>

                            {{-- Animal Sell Menu List --}}
                            <li><a><i class="fa fa-bar-chart-o"></i> পশু ক্রয়/বিক্রয় <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                            ...
                            <li><a><i class="fa fa-clone"></i>ফার্মের খরচ <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                    ...
                    <div class="menu_section">
                        <h3>Live On</h3>
                        <ul class="nav side-menu">
                            <li><a><i class="fa-solid fa-hippo"></i> পশু মনিটরিং <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
