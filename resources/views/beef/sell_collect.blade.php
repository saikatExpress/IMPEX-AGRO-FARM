                                            ...
                                            @foreach ($dueList as $key => $sell)
                                                <tr class="list-item">
                                                    ...
                                                    <td>
                                                        ...
                                                        data-id="{{ $sell->id }}" data-name="{{ $sell->name }}" data-due="{{ $sell->due }}">
                                                            <i class="fa-regular fa-pen-to-square"></i>
                                                        </button>
                                                        <button class="btn btn-sm btn-danger deleteButton" data-id="{{ $sell->id }}">
    ...
    <div class="modal fade" id="myModal">
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                ...
                <form class="" action="{{ route('sell.edit') }}" method="post" novalidate>
                    @csrf
                    ...
                    <div class="field item form-group">
                        <label class="col-form-label col-md-3 col-sm-3  label-align">Due<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6">
                    ...
                    <div class="field item form-group">
                        <label class="col-form-label col-md-3 col-sm-3  label-align">Payment<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6">
